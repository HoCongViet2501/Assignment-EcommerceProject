            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                {(localStorage.getItem("userRole") === "ADMIN") ?
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <Link to={"/admin/users/orders"} className="nav-link text-light mx-3">
                        ...
                        <li className="nav-item">
                            <Link to={"/products/"} className="nav-link text-light mx-3">
                                <FontAwesomeIcon className="mr-2" icon={faList}/>List of product</Link>
                        </li>
                    </ul>
                    :
                    <ul className="navbar-nav">
