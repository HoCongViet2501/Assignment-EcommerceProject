...
import { fetchResetPasswordCode, formReset} from "../../actions/auth-actions";
...
export default connect(mapStateToProps, { fetchResetPasswordCode, formReset})(ResetPassword);
